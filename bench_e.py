...
import sys
sys.path.append("C:\\Users\\tvelletaz\\Documents\\Théo\\ModPuls\\code\\data")
from tools import *
from SNN_tools_e import *
...
if dyn_feats:
    ...
    learning_r_snn = 5e-5
    # On dyn feats:
    base_path = 'C:/Users/tvelletaz/Documents/Théo/MODPULS/Code/data/dataset/both_cond_only/'
...
base_path = 'C:/Users/tvelletaz/Documents/Théo/MODPULS/Code/data/dataset/both_cond_only/raw_velocities/loo_splits/'
# Sauvegarde
with open(base_path +"accs_model.pkl", "wb") as f:
    pickle.dump(accs_model, f)

with open(base_path +"metrics_model.pkl", "wb") as f:
    pickle.dump(metrics_model, f)

with open(base_path +"accs_val_model.pkl", "wb") as f:
